...
import { Beaker, Swords, LayoutDashboard, Brain, Menu, X } from 'lucide-react';
...
export default function Sidebar() {
  ...
  return (
    <>
      {/* 1. Toggle Button (Always visible top-left) */}
      <button 
        onClick={() => setIsOpen(!isOpen)}
        className="fixed top-4 left-4 z-[60] p-2 bg-gray-800 rounded-lg text-white hover:bg-gray-700 transition-colors shadow-lg border border-gray-700"
      >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="h-screen w-64 glass-panel border-r border-gray-800 flex flex-col fixed left-0 top-0 z-50 pt-16" // Added pt-16 to clear button
          >
